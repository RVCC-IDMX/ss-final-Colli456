...
This is a multi-styled web page that heavily utilizes the hover effect.
After setting up all the installations I used my mobile-first assignment as a starting point
I then included a reset/normalize library
Then used the ::before and ::after
Next, I changed the layout a bit 
After that I added different styles to each section of the webpage. 
Lastly, I used Lighthouse to check the load times and to ensure there are no accessibility issues
